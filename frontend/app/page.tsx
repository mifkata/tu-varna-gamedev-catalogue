  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="text-center p-8">
        <h1 className="text-5xl font-bold text-gray-900 mb-4">GameDev Каталог</h1>
        <p className="text-xl text-gray-600 mb-8">
          Full-stack приложение с NestJS, Fastify, Next.js и TypeORM
        </p>
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto mb-8">
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Технологичен стек</h2>
        ...
        <div className="flex gap-4 justify-center">
          <Link href="/game-developers">
            <Button size="lg">Разгледай разработчици</Button>
          </Link>
          <Link href="/games">
