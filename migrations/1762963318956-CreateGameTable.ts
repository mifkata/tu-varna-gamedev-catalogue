...
export class CreateGameTable1762963318956 implements MigrationInterface {
  name = 'CreateGameTable1762963318956';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "games" (
            "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
            "name" character varying NOT NULL,
            "min_cpu" numeric(10,2) NOT NULL,
            "min_memory" integer NOT NULL,
            "multiplayer" boolean NOT NULL DEFAULT false,
            "created_at" TIMESTAMP NOT NULL DEFAULT now(),
            "updated_at" TIMESTAMP NOT NULL DEFAULT now(),
            "developer_id" uuid NOT NULL,
            "category_id" uuid NOT NULL,
            CONSTRAINT "UQ_c7d96d091489e8f7c8503994a99" UNIQUE ("developer_id", "name"),
